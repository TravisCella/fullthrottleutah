  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content:
        "Hey! 👋 I'm the Full Throttle Utah assistant. Ask me anything about our jet ski rentals — pricing, availability, what's included, locations, you name it.",
    },
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: 'assistant',
          content:
            "Oops, I'm having connection issues right now. You can book directly at fullthrottleutah.com or text us for help!",
        },
      ]);
    }
      ...
      <button
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow =
            '0 6px 28px rgba(216,90,48,0.5), 0 3px 12px rgba(0,0,0,0.2)';
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = 'scale(1)';
          e.currentTarget.style.boxShadow =
            '0 4px 20px rgba(216,90,48,0.4), 0 2px 8px rgba(0,0,0,0.15)';
        }}
      >
        💬
      </button>
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div style={{ color: '#fff', fontSize: 14, fontWeight: 600, letterSpacing: '-0.3px' }}>
              Full Throttle Utah
            </div>
      ...
      {messages.length <= 2 && (
        ...
        >
          {['What are your prices?', "What's included?", 'Do you deliver?', 'Which lakes?'].map(
            (q) => (
              <button
                key={q}
                onClick={() => {
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.background = '#fef8f5';
                }}
                onMouseLeave={(e) => {
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            background:
              input.trim() && !loading ? `linear-gradient(135deg, ${accent}, #c44e28)` : '#ddd',
            color: '#fff',
            fontSize: 18,
