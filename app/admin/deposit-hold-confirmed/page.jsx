    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Your refundable security deposit hold has been placed successfully. Your card will <strong>not be charged</strong> unless damage is documented after your rental.
        </p>
        ...
        <div style={{
          ...
          <ul style={{
            ...
            <li>After your rental returns clean, the hold is released — funds reappear within 5–10 business days depending on your bank</li>
        ...
        <p style={{ fontSize: 14, color: '#0F172A', fontWeight: 600 }}>
          Travis — <a href="tel:+18015481273" style={{ color: '#EA580C', textDecoration: 'none' }}>(801) 548-1273</a>
        </p>
