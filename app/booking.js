...
function ImageGallery({ images: imgKeys }) {
  ...
  return (
    <div
      style={{ position: 'relative', borderRadius: 16, overflow: 'hidden', background: '#0B1120' }}
    >
      <img
...
function Calendar({
  ...
  return (
    <div style={{ userSelect: 'none' }}>
      ...
      >
        <button onClick={() => onChangeMonth(-1)} style={navBtn}>
          {'‹'}
        </button>
        <span
          style={{
      ...
      >
        ...
        {cells.map((day, i) => {
              ...
              for (const p of premiumDates) {
                ...
                if (thisDay >= pStart && thisDay <= pEnd) {
                  if (p.flatAdd !== 0) premiumAdj += p.flatAdd;
                    ...
                    premiumAdj += Math.round(baseRate * (p.multiplier - 1));
                }
              }
            }
            dayPrice = Math.max(
              0,
              baseRate + (holidayMatch ? holidayMatch.premium : 0) + premiumAdj
            );
          }
          ...
          return (
            <div
              key={i}
              onClick={() => day && !unavailable && onSelectDate(new Date(year, month, day))}
              style={{
                padding: '8px 0 6px',
                fontSize: 13,
                ...
                background: sel
                  ...
                  : booked
                    ...
                    : holiday && !past
                      ...
                      : 'transparent',
                borderRadius:
                  start && end ? 8 : start ? '8px 0 0 8px' : end ? '0 8px 8px 0' : sel ? 0 : 8,
...
export default function JetSkiBooking() {
  ...
  const basePrice =
    pkg && days > 0
      ? calculateBasePrice(pkg, dates[0], dates.length === 2 ? dates[1] : dates[0])
      : 0;
  const holidayInfo =
    dates.length > 0
      ? getHolidaySurcharge(dates[0], dates.length === 2 ? dates[1] : dates[0])
      : { total: 0, holidays: [] };
  ...
  const loyaltyDiscount = isRepeatCustomer ? Math.round(basePrice * 0.1) : 0;
  const { adjustment: promoAdjustment, reason: promoReason } =
    dates.length > 0
      ? computePremiumAdjustment(
          premiumDates,
          dates[0],
  ...
  const timesValid = days <= 1 ? timeToMinutes(pickupTime) < timeToMinutes(returnTime) : true;
  ...
  if (step === -1) {
    return (
      ...
      >
        <link
          href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800;900&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;0,900;1,600&display=swap"
          rel="stylesheet"
        />

        <div style={{ position: 'relative', height: 420, overflow: 'hidden' }}>
          <img
            src={IMAGES.sparkHero}
            alt="Sea-Doo Sparks on Utah reservoir"
            style={{
              width: '100%',
              height: '100%',
              objectFit: 'cover',
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                'linear-gradient(180deg, rgba(11,17,32,0.3) 0%, rgba(11,17,32,0.1) 40%, rgba(11,17,32,0.85) 85%, #0B1120 100%)',
            }}
          />
          <div
            style={{
          ...
          >
            ...
            >
              Premium jet ski, UTV, and powersport rentals across every major Utah destination. Book
              online in 2 minutes.
            </p>
          </div>
        </div>
        ...
        <div style={{ padding: '32px 20px' }}>
                ...
                style={{
                  ...
                  background:
                    idx === 0
                      ...
                      : 'linear-gradient(135deg, #1a1a2e 0%, #2d1f0f 100%)',
                }}
              />
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: '#94A3B8' }}>
                  Starting at $150, varies by destination
                </div>
              </div>
            </div>
            <div style={{ fontSize: 12, color: '#64748B', lineHeight: 1.5 }}>
              Skip the towing. We bring the watercraft to your lake, launch it, and pick it up when
              you're done. Pricing is location-based — nearby lakes start at $150. You'll see the
              exact fee for your chosen destination when you book.
            </div>
          </div>
          ...
          >
            <img
              src="/images/logo.png"
              alt="Full Throttle Utah"
              style={{ width: 160, height: 'auto', marginBottom: 12, opacity: 0.6 }}
            />
            <div style={{ fontSize: 11, color: '#475569', lineHeight: 1.6 }}>
              Pickup from Farmington, UT · 8 AM – 8 PM
              <br />
              2" ball hitch + valid ID required
              <br />
              <a href="/cancellation-policy" style={{ color: '#0EA5E9', textDecoration: 'none' }}>
                Cancellation & Weather Policy
              </a>
              <br />
              <span style={{ color: '#64748B' }}>
                © {new Date().getFullYear()} TW Assets LLC d/b/a Full Throttle Utah
              </span>
            </div>
          </div>
        </div>
    ...
    >
      ...
      <div style={{ padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div
              style={{ fontSize: 14, fontWeight: 600, color: '#0F172A', letterSpacing: '-0.01em' }}
            >
              {stepLabels[step] || 'Confirm'}
            </div>
          </div>
        </div>
      ...
      <div
        style={{
          ...
          opacity: fadeIn ? 1 : 0,
          transform: fadeIn ? 'none' : 'translateY(10px)',
      ...
      >
                  ...
                  <div style={{ padding: '18px 20px 20px' }}>
                    ...
                    >
                      <div>
                        ...
                        <div
                          style={{ fontSize: 12, color: '#64748B', marginTop: 2, fontWeight: 500 }}
                        >
                          {p.tagline}
                        </div>
                      </div>
          ...
          <div>
            ...
            {loc?.aisStatus === 'infested' && (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginBottom: 8 }}>
                  ...
                  <div>
                    <div
                      style={{ fontSize: 13, fontWeight: 700, color: '#92400E', marginBottom: 2 }}
                    >
                      Lake Powell Special Requirements
                    </div>
                    <div style={{ fontSize: 11, color: '#92400E', lineHeight: 1.5 }}>
                      Quagga mussel-infested waterbody. Per Utah DWR:
                    </div>
                  </div>
                </div>
                <div style={{ fontSize: 11, color: '#92400E', lineHeight: 1.7, paddingLeft: 26 }}>
                  • <strong>3-day minimum</strong> rental required
                  <br />• <strong>$200 decontamination fee</strong> auto-added
                  <br />
                  • Professional decon performed at return
                  <br />• Machine quarantined 30 days after use
                </div>
              </div>
            )}
            ...
            {loc?.minDays && loc?.aisStatus !== 'infested' && !overrideMinDays && (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
                  ...
                  <div>
                    <div
                      style={{ fontSize: 13, fontWeight: 700, color: '#1E40AF', marginBottom: 2 }}
                    >
                      {loc.name} — {loc.minDays}-day minimum rental
                    </div>
                    <div style={{ fontSize: 11, color: '#1E40AF', lineHeight: 1.5 }}>
                      This destination is {loc.drive} from Farmington each way. To make the trip
                      worthwhile for you (and for us to dedicate the watercraft to your
                      reservation), we require a minimum {loc.minDays}-day booking. Multi-day
              ...
              <div style={{ marginTop: 20 }}>
                ...
                {loc.whiteGloveFee === null ? (
                  ...
                  >
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: 11, color: '#64748B', marginTop: 1 }}>
                            {loc.name} — call for quote
                          </div>
                        </div>
                      </div>
                      <a
                        href="tel:+17148566576"
                        style={{
                          display: 'flex',
                          alignItems: 'center',
                          gap: 6,
                    ...
                    >
                      Lake Powell deliveries are 600+ mile round-trips and quoted individually. Call
                      us at (714) 856-5676 to discuss your trip and pricing.
                    </div>
                  </div>
                ) : (
                  <div
                  ...
                  >
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                        ...
                        <div>
                          <div style={{ fontSize: 15, fontWeight: 600 }}>White Glove Delivery</div>
                          <div style={{ fontSize: 11, color: '#64748B', marginTop: 1 }}>
                            We deliver, launch & retrieve at {loc.name}
                          </div>
                        </div>
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        <div
                          style={{
                            fontSize: 18,
                            fontWeight: 800,
                            color: whiteGlove ? '#16A34A' : '#0F172A',
                          }}
                        >
                          +${loc.whiteGloveFee}
                        </div>
                    ...
                    {whiteGlove && (
                      ...
                      >
                        We'll deliver your watercraft to the ramp at {loc.name}, launch it, and pick
                        it up when you're done. No towing needed — just show up and ride. Fee covers
                        all delivery, launch, and recovery costs; no additional fuel charges at
                        pickup.
                      </div>
                    )}
                  </div>
            ...
            >
              <div style={{ fontSize: 12, color: '#1E40AF', lineHeight: 1.5 }}>
                <strong>{whiteGlove ? 'We deliver to the lake!' : 'Pickup:'}</strong>{' '}
                {whiteGlove
                  ? `We'll bring the watercraft to ${loc?.name || 'your chosen lake'} and launch it for you.`
                  : 'Farmington, UT — you tow to the lake with your own vehicle. 2" ball hitch and flat 4-prong light hookup required.'}
              </div>
            </div>
          </div>
        )}
          ...
          <div>
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 12, opacity: 0.6, marginTop: 2 }}>
                      {formatDate(dates[0])}
                      {dates.length === 2 ? ` → ${formatDate(dates[1])}` : ''}
                    </div>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    ...
                    {days > 1 && (
                      <div style={{ fontSize: 11, opacity: 0.6 }}>
                        ${Math.round(totalPrice / days)}/day avg
                      </div>
                    )}
                  </div>
                </div>
                {(holidayInfo.total > 0 ||
                  ...
                  >
                    ...
                    {holidayInfo.holidays.map((h) => (
                      ...
                      >
                        <span>🎆 {h.name} surcharge</span>
                        <span>+${h.premium}/day</span>
                      </div>
                    ))}
                    {whiteGlove && whiteGloveFee > 0 && (
                      ...
                      >
                        <span>🤝 White glove — {loc.name}</span>
                        <span>+${whiteGloveFee}</span>
                      </div>
                    )}
                    {deconFee > 0 && (
                      <div
                      ...
                      >
                        <span>🦠 Lake Powell decontamination</span>
                        <span>+${deconFee}</span>
                      </div>
                    )}
                    {extraVestFee > 0 && (
                      ...
                      >
                        <span>
                          🪖 Spare vest{spareVestCount === 1 ? '' : 's'} ({spareVestCount} × $
                          {EXTRA_VEST_FEE})
                        </span>
                        <span>+${extraVestFee}</span>
                      </div>
                    )}
                    {loyaltyDiscount > 0 && (
                      <div
                    ...
                    {promoAdjustment < 0 && (
                      ...
                      >
                        <span>🏷️ {promoReason || 'Promo'}</span>
                        <span>-${Math.abs(promoAdjustment)}</span>
                      </div>
                    )}
                    {promoAdjustment > 0 && (
                      <div
                      ...
                      >
                        <span>📈 {promoReason || 'Surcharge'}</span>
                        <span>+${promoAdjustment}</span>
                      </div>
                    )}
                  </div>
                )}
            ...
            {dates.length > 0 && (
              ...
              >
                ...
                >
                  ⏱ Arriving more than 1 hour past your scheduled pickup time may result in a{' '}
                  <strong>$50 late pickup fee</strong> charged to your card on file.
                </div>
        ...
        {step === 3 && !done && (
          <div>
                ...
                {f.k === 'phone' && isRepeatCustomer && (
                  ...
                  >
                    ...
                    <div style={{ fontSize: 12, color: '#15803D', lineHeight: 1.4 }}>
                      <strong>Welcome back!</strong> You're getting 10% off your rental as a
                      returning customer.
                    </div>
                  </div>
                )}
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                {['First timer', 'A few times', 'Experienced', 'Expert'].map((lv) => (
                  <div
                    key={lv}
                    onClick={() => setInfo({ ...info, experience: lv })}
                    style={{
                      padding: '12px',
                      borderRadius: 10,
            ...
            >
              <span style={{ fontSize: 18 }}>📋</span>
              <div style={{ fontSize: 12, color: '#92400E', lineHeight: 1.5 }}>
                <strong>Digital waiver required.</strong> After booking you'll receive a Smartwaiver
                link. All riders must sign before pickup.
              </div>
            </div>
            ...
            <div
              style={{
                ...
                borderRadius: 12,
                padding: 14,
                background: info.smsOptIn ? 'rgba(14,165,233,0.04)' : '#fff',
              }}
            >
              <label
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: 13, fontWeight: 600, color: '#0F172A', marginBottom: 4 }}>
                    📱 Text me booking updates{' '}
                    <span style={{ color: '#64748B', fontWeight: 400, fontStyle: 'italic' }}>
                      (Optional)
                    </span>
                  </div>
                  <div style={{ fontSize: 11, color: '#64748B', lineHeight: 1.5 }}>
                    I agree to receive SMS notifications from Full Throttle Utah about my
                    reservation (booking confirmation, pickup/return reminders, and follow-up).
                  ...
                  >
                    Consent is not required to complete your booking — you'll still receive email
                    confirmations.
                  </div>
                </div>
              </label>
            ...
            >
              ...
              >
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 11, color: '#64748B', marginTop: 4, lineHeight: 1.5 }}>
                    USCG-approved PFDs. {maxVests} included free (one per seat). Skip and we'll
                    bring 2 Adult Mediums.
                  </div>
                </div>
              ...
              {spareVestCount > 0 && (
                ...
                >
                  <strong>
                    🪖 {spareVestCount} spare vest{spareVestCount === 1 ? '' : 's'} (+$
                    {extraVestFee})
                  </strong>{' '}
                  — boat capacity stays at {maxVests} riders. Spares are backups (sizing, wet,
                  rotation).
                </div>
              )}
              ...
              >
                <strong>Boat capacity: {maxVests} riders</strong> (
                {pkg?.id === 'gtx-duo'
                  ? '3 per GTX × 2 skis'
                  : pkg?.id === 'trixx-single'
                    ? '3 on one Trixx'
                    : '2 per Spark × 2 skis'}
                ). Spare vests $15 each (max +{MAX_EXTRA_VESTS}). Actual rider count cannot exceed
                boat capacity.
              </div>
            </div>
          </div>
        ...
        {step === 4 && !done && (
          <div>
            ...
            <div style={{ fontSize: 12, color: '#64748B', lineHeight: 1.5, marginBottom: 16 }}>
              Please read each section carefully and check each box to acknowledge you understand
              and agree.
            </div>
            ...
            {[
              ...
              {
                key: 'ais',
                title: 'Aquatic Invasive Species (AIS) Compliance',
              ...
              },
              {
                key: 'noLakePowell',
                title: isLakePowell
                  ? 'Lake Powell Decontamination Acknowledgment'
                  : 'Mussel-Infested Water Prohibition',
                text: isLakePowell
                ...
                <div style={{ padding: '14px 16px' }}>
                  ...
                  >
                    <input
                      ...
                      onChange={() =>
                        setWaiverChecks((prev) => ({ ...prev, [section.key]: !prev[section.key] }))
                      }
            ...
            >
              <div style={{ fontSize: 12, color: '#1E40AF', lineHeight: 1.5 }}>
                <strong>Signed by:</strong> {info.name} · {info.email}
                <br />
                <strong>Date:</strong>{' '}
        ...
        {step === 5 && !done && (
          <div>
            ...
            <div style={{ fontSize: 12, color: '#64748B', lineHeight: 1.5, marginBottom: 14 }}>
              Please read the entire agreement, acknowledge each item below, and sign at the bottom.
              This is separate from the Liability Waiver you just signed.
            </div>
            ...
            >
              {/* Title + version */}
              <div
                style={{ borderBottom: '1px solid #E2E8F0', paddingBottom: 12, marginBottom: 16 }}
              >
                <div
                  style={{
                    fontSize: 16,
                ...
                <div
                  style={{ fontSize: 10, color: '#94A3B8', marginTop: 4, letterSpacing: '0.05em' }}
                >
              ...
              <div style={{ marginBottom: 18 }}>
                ...
                {AGREEMENT_PREAMBLE.about.map((p, i) => (
                  <p key={i} style={{ margin: '0 0 10px', color: '#475569' }}>
                    {p}
                  </p>
                ))}
              </div>
              ...
              {AGREEMENT_CHECKBOXES.map((cb) => (
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      setAgreementChecks((prev) => ({ ...prev, [cb.id]: !prev[cb.id] }))
                    }
                    style={{
                      width: 20,
                      height: 20,
            ...
            <div style={{ marginTop: 20 }}>
              ...
              <div style={{ fontSize: 12, color: '#64748B', marginBottom: 10 }}>
                Sign below to execute this Rental Agreement. This is separate from your Liability
                Waiver signature.
              </div>
              <div style={{ position: 'relative' }}>
                <canvas
                  ...
                  style={{
                    ...
                    height: 140,
                    background: '#FAFBFC',
                    cursor: Object.values(agreementChecks).every(Boolean)
                      ? 'crosshair'
                      : 'not-allowed',
                    touchAction: 'none',
            ...
            >
              <div style={{ fontSize: 12, color: '#1E40AF', lineHeight: 1.5 }}>
                <strong>Signed by:</strong> {info.name} · {info.email}
                <br />
                <strong>Agreement version:</strong> {AGREEMENT_VERSION}
                <br />
                <strong>Date:</strong>{' '}
                {new Date().toLocaleDateString('en-US', {
                  weekday: 'long',
        ...
        {step === 6 && !done && (
          <div>
              ...
              {[
                {
                  ...
                  sub: whiteGlove
                    ...
                    : isLakePowell
                      ? '🦠 Decon performed at return'
                      : loc?.drive + ' from SLC',
                },
                {
                  label: 'Dates',
                  value: `${formatDate(dates[0])}${dates.length === 2 ? ` → ${formatDate(dates[1])}` : ''}`,
                  sub: `${days} day${days > 1 ? 's' : ''} · Pickup ${formatTime12h(pickupTime)} · Return ${formatTime12h(returnTime)}`,
                },
                {
                  label: 'Renter',
                  value: info.name,
                  sub: `${info.email} · ${info.phone} · ${info.experience}`,
                },
                {
                  label: 'Life Vests',
                  value: effectiveVestSummary,
                  sub:
                    totalVests === 0
                      ? "Default selection — we'll bring 2 Adult Mediums"
                      : `${totalVests} rider${totalVests === 1 ? '' : 's'} total`,
                },
              ].map((row, i) => (
              ...
              <div style={{ padding: '16px 18px', background: '#F8FAFC' }}>
                {[
                  ...
                  ...(extraVestFee > 0
                    ? [
                        {
                          l: `🪖 Spare vest${spareVestCount === 1 ? '' : 's'} (${spareVestCount} × $${EXTRA_VEST_FEE})`,
                          v: `+$${extraVestFee}`,
                          color: '#D97706',
                        },
                      ]
                  ...
                  ...(promoAdjustment < 0
                    ? [
                        {
                          l: `🏷️ ${promoReason || 'Promo'}`,
                          v: `-$${Math.abs(promoAdjustment)}`,
                          color: '#16A34A',
                        },
                      ]
                    : []),
                  ...
                  <div
                    ...
                    style={{
                      ...
                      color: r.color || (r.bold ? '#0F172A' : '#64748B'),
                    }}
                  >
                    <span>{r.l}</span>
                ...
                >
                  <div style={{ fontSize: 12, fontWeight: 700, color: '#92400E', marginBottom: 4 }}>
                    🔐 At Pickup: ${(pkg?.deposit || 1000).toLocaleString()} Security Deposit
                  </div>
                  <div style={{ fontSize: 11, color: '#92400E', lineHeight: 1.5 }}>
                    A ${(pkg?.deposit || 1000).toLocaleString()} security deposit will be held at
                    pickup via card hold or accepted in cash. Released in full upon satisfactory
                    return of the watercraft.
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              By booking you agree to our rental terms. View our{' '}
              <a href="/cancellation-policy" style={{ color: '#0EA5E9', textDecoration: 'none' }}>
                cancellation & weather policy
              </a>
              .
          ...
          <div style={{ textAlign: 'center', padding: '32px 0' }}>
            ...
            >
              ...
              {[
                ...
                whiteGlove
                  ? "We'll deliver to the lake — just show up and ride!"
                  : `Arrive at Farmington pickup by ${formatTime12h(pickupTime)}`,
                ...
                <div key={i} style={{ display: 'flex', gap: 12, marginBottom: 12 }}>
                  ...
                  <span style={{ fontSize: 13, color: '#64748B', lineHeight: 1.5, paddingTop: 2 }}>
                    {s}
                  </span>
                </div>
              ))}
            ...
            <button
              onClick={() => {
                ...
                setAgreementSignature(null);
                setAgreementScrollComplete(false);
                setDone(false);
                setWhiteGlove(false);
                setIsRepeatCustomer(false);
                setVestSizes(EMPTY_VESTS);
