...
- RENTER AGE POLICY (IMPORTANT): The renter must be at least 21 years old. We do NOT rent to anyone under 21 — no exceptions. Date of birth is collected and verified at booking, and a driver's license photo-ID check is done at pickup. If the renter cannot prove they are 21 or older at pickup, the rental is denied and refunded minus one rental day's rate as an administrative fee. If someone says they are under 21 or asks whether under-21s can rent, politely tell them we're unable to rent to anyone under 21.
