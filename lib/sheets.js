...
// ─── 2026-06-02: addBooking now writes column S (vest_sizes) ──────────────
//
...
//   S vest_sizes  ← NEW
//
// IMPORTANT: Travis must add the header "vest_sizes" to Sheet1 column S
// manually in the Google Sheet. Without that header, data still writes
// correctly but the column won't have a label.
...
export async function addBooking(booking) {
  ...
  const values = [[
    ...
    booking.vest_summary || '',                                       // S vest_sizes (NEW)
  ]];
