...
// ─── 2026-06-02 PM: addBooking now writes columns T + U (times) ───────────
//
...
//   R sms_opt_in,
//   S vest_sizes,
//   T pickup_time,   ← NEW (e.g. "8:00 AM")
//   U return_time    ← NEW (e.g. "8:00 PM")
//
// IMPORTANT: Travis must add headers "pickup_time" to cell T1 and "return_time"
// to cell U1 manually in the Google Sheet. Data still writes correctly without
// the headers — they just won't have labels.
...
export async function addBooking(booking) {
  ...
  const values = [[
    ...
    booking.pickup_time_display || '8:00 AM',                         // T pickup_time (NEW)
    booking.return_time_display || '8:00 PM',                         // U return_time (NEW)
  ]];
