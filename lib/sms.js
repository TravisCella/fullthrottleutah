// lib/sms.js
// Version: 2026-06-02 — Surface life vest selection in customer + owner SMS
// Last edited: June 2 2026
// Change: Both buildBookingConfirmationSMS() and buildOwnerNotificationSMS()
//         now include a 🦺 vest line when booking.vest_summary is present.
//         Customer sees it right after the pickup/delivery line. Owner sees
//         it at the bottom of the alert.
//
// Note: The webhook (app/api/webhook/route.js) currently builds the owner SMS
//       inline rather than calling buildOwnerNotificationSMS(), but we update
//       both for consistency in case the helper starts being used.
//
// Builds on: lib-sms_2026-06-01_defensive-multi-recipient.js
