...
// ─── Current version ────────────────────────────────────────────────────────
export const AGREEMENT_VERSION = 'v1.4.0';
export const AGREEMENT_EFFECTIVE_DATE = '2026-07-07';
...
export const AGREEMENT_SECTIONS = [
  {
    ...
    clauses: [
      {
        id: '1.1',
        text: 'You are at least twenty-five (25) years of age. FTU rents only to renters who are 25 or older; there are no exceptions.',
      },
      {
        id: '1.2',
        text: 'The name, address, phone number, and email provided during booking are true and accurate.',
      },
      {
        id: '1.3',
        text: 'You hold a valid, current Utah Boating Safety Course completion card if you were born on or after January 1, 1986, as required by Utah Code §73-18-9, OR you will obtain one prior to operating the rented equipment.',
      },
      {
        id: '1.4',
        text: 'You will be the primary operator. If others will operate the equipment, you affirm they meet the eligibility requirements above and will provide their information to FTU upon request.',
      },
      {
        id: '1.5',
        text: "You have not had a watercraft operator's license suspended or revoked in any jurisdiction within the past five (5) years.",
      },
      {
        id: '1.6',
        text: "Age verification at pickup. FTU verifies the renter's age against a valid government-issued photo ID (driver's license) at pickup. If the renter cannot present valid ID showing they are at least twenty-five (25) years of age, the rental will be denied. In that event, FTU will refund amounts paid except for one (1) rental day's rate, which is retained as a non-refundable administrative fee for the reserved and forfeited rental day.",
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: '2.1',
        text: 'Full payment is due at booking. The total rental price displayed at checkout — including base rental, white-glove delivery (if applicable), spare vest fees (if applicable), Lake Powell decontamination fees (if applicable), and any other line items — is charged in full at the time of booking via Stripe.',
      },
      {
        id: '2.2',
      ...
      {
        id: '2.3',
        text: 'Payment failures. If your card is declined for any charge under this Agreement, you remain liable for the full amount owed and agree to provide an alternative payment method within seventy-two (72) hours of notification.',
      },
      {
        id: '2.4',
        text: 'Late pickup fee. Your scheduled pickup time is confirmed at booking. If you arrive more than one (1) hour past your scheduled pickup time without prior notice to FTU, a $50.00 late pickup fee will be charged to your card on file. This fee compensates FTU for reserved staff time and held equipment. FTU retains sole discretion to waive this fee in documented extenuating circumstances.',
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: '3.1',
        text: "The cancellation tiers below apply to all rental bookings. By signing this Agreement you acknowledge having reviewed FTU's posted Cancellation Policy at fullthrottleutah.com/cancellation-policy and that the terms here govern in case of any conflict.",
      },
      {
        id: '3.2',
      ...
      {
        id: '3.4',
        text: "Customer-initiated weather cancellations are subject to the timing tiers in Section 3.2 above. FTU is not obligated to cancel for weather unless conditions meet FTU's safety threshold.",
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: '4.1',
        text: 'A security deposit is required for each rental ($750 for the Sea-Doo Spark Trixx (3UP); $1,000 for the Spark Duo; $2,000 for the GTX Limited Duo). The deposit may be collected by FTU either as:',
        bullets: [
      ...
      {
        id: '4.3',
        text: 'Any remaining balance of the deposit will be released or refunded to you within seven (7) business days of rental return, subject to bank processing times.',
      },
      {
        id: '4.4',
        text: 'Deposit insufficiency. If damages, fees, and other amounts exceed the security deposit, you remain liable for the difference, which FTU may charge to your card-on-file, invoice you for, or refer to collections under Section 12.',
      },
      {
        id: '4.5',
        text: 'Pre-authorization disclosure. A pre-authorization hold reserves funds on your card but is not a charge unless captured. The hold may appear on your statement until released. Standard release times depend on your bank but typically range from 5 to 10 business days.',
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: '5.1',
        text: "You are responsible for all damage to the rented equipment occurring from the moment of pickup until the equipment is returned to FTU's care, regardless of cause and regardless of fault, except for damage caused by FTU's own gross negligence or pre-existing defects documented at check-out.",
      },
      {
        id: '5.2',
        text: "Pre-existing damage is documented through the FTU Inspect check-out process at the start of each rental. Photographs taken at check-out establish the equipment's condition at the start of your rental window. You are encouraged to review these photos and immediately report any concerns to FTU.",
      },
      {
        id: '5.3',
      ...
      },
      {
        ...
        footer:
          'Values are estimates; actual replacement cost will be determined at time of incident.',
      },
      {
        id: '5.6',
        text: 'Repair cost ceiling. For repairable damage, your liability is capped at the lesser of (a) the actual repair cost or (b) the replacement value of the damaged unit.',
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: '6.1',
        text: 'All rented Personal Watercraft (PWC) require 91-octane premium unleaded gasoline only. Use of any lower octane fuel, ethanol-blended fuel exceeding E10, or any other fuel type may damage the engine and constitutes a breach of this Agreement.',
      },
      {
        id: '6.2',
        text: 'Return condition. Equipment must be returned with a full tank of 91-octane gasoline.',
      },
      {
        id: '6.3',
        ...
        footer:
          'This charge will be deducted from your deposit or charged to your card-on-file under Section 2.2.',
      },
      {
        id: '6.4',
        text: 'Wrong fuel. If you fuel the equipment with the wrong octane or fuel type and damage results, you are liable for all repair costs as set forth in Section 5.',
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: '7.1',
        text: "The agreed return time is specified in your booking confirmation. The standard pickup is 8:00 AM at FTU's Farmington, UT location (or at the lake for white-glove deliveries); the standard return is 8:00 PM the same day or final rental day. Custom times may be agreed to at booking.",
      },
      {
        id: '7.2',
      ...
      {
        id: '7.4',
        text: 'Communication. You must notify FTU as soon as possible — and in no case later than the agreed return time — if you anticipate being late. FTU may, at our sole discretion, extend the return time without penalty if conditions warrant.',
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: '8.1',
        text: 'Designated water body only. The rented equipment may be operated only on the body of water specified in your booking confirmation. Transport to or operation on any other body of water is strictly prohibited and constitutes a material breach of this Agreement.',
      },
      {
        id: '8.2',
        text: 'No subletting or transfer. You may not assign, sublet, rent, or otherwise transfer your rights under this Agreement. Only persons identified to FTU as authorized operators may operate the equipment.',
      },
      {
        id: '8.3',
        text: 'No commercial use. The equipment may not be used for commercial purposes including but not limited to: paid passenger rides, photography for commercial sale, tournaments, races, instruction for compensation, or filming for commercial publication.',
      },
      {
        id: '8.4',
        text: 'Capacity limits. USCG-rated capacity strictly applies:',
        bullets: [
          'Sea-Doo Spark Trixx 3-up: Three (3) persons maximum (single unit)',
        ...
        footer:
          'Exceeding these limits violates U.S. Coast Guard regulations and voids any insurance coverage.',
      },
      {
        id: '8.5',
        text: 'Personal flotation devices (PFDs). USCG-approved PFDs must be worn by all occupants whenever the engine is running. FTU provides PFDs in the sizes selected during booking. Use of non-FTU PFDs requires they be USCG-approved.',
      },
      {
        id: '8.6',
        text: 'Daylight operation only. Operation is restricted to between thirty (30) minutes after sunrise and thirty (30) minutes before sunset, per Utah law, unless equipment is specifically equipped with proper lighting and FTU provides written permission.',
      },
      {
        id: '8.7',
  ...
  },
  {
    ...
    clauses: [
      ...
      {
        id: '9.3',
        text: 'Distance and speed. You will maintain safe distances from other vessels, swimmers, docks, and shorelines, and will obey posted speed limits and no-wake zones.',
      },
      {
        id: '9.4',
      ...
      {
        id: '9.5',
        text: 'Boarding by FTU. FTU reserves the right to terminate the rental and recover the equipment at any time if you violate Section 9 in a manner that endangers persons or property. In such case, no refund is owed and you remain liable for all charges through that point.',
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: '10.1',
        text: 'You acknowledge that Lake Powell and certain other Utah waters are designated as quagga mussel-infested by the Utah Division of Wildlife Resources. Aquatic Invasive Species (AIS) violations carry both legal and financial consequences.',
      },
      {
        id: '10.2',
      ...
      {
        id: '10.3',
        text: 'No cross-water transport. You shall not transport the rented equipment from one body of water to another during the rental period. Equipment must remain at the designated lake from delivery/pickup to return.',
      },
      {
        id: '10.4',
        text: 'Inspection cooperation. You agree to cooperate with all AIS inspections by state, federal, or local authorities, including pre-departure inspections required at Lake Powell exits.',
      },
      {
        id: '10.5',
  ...
  },
  {
    ...
    clauses: [
      ...
      {
        id: '11.2',
        text: 'Survival. Your indemnification obligations under this Section 11 survive termination or expiration of this Agreement.',
      },
    ],
  },
  {
    ...
    clauses: [
      ...
      {
        id: '12.3',
        text: "Attorney's fees. In any action arising from your default, you agree to pay FTU's reasonable attorney's fees and costs of collection, whether or not litigation is commenced.",
      },
      {
        id: '12.4',
        text: 'Governing law and venue. This Agreement is governed by the laws of the State of Utah without regard to its conflicts of law principles. Any dispute arising from this Agreement shall be resolved in the state or federal courts located in Davis County, Utah, and you consent to the personal jurisdiction of those courts.',
      },
      {
        id: '12.5',
        text: 'Severability. If any provision of this Agreement is found unenforceable, the remaining provisions remain in full force.',
      },
      {
        id: '12.6',
    ...
    clauses: [
      {
        ...
        bullets: [
          ...
          'You are at least twenty-five (25) years of age and have legal capacity to enter into this Agreement',
          'You are entering this Agreement voluntarily and without duress',
        ],
      },
      {
        id: '13.2',
        text: 'You may request a copy of this signed Agreement at any time by emailing bookings@fullthrottleutah.com.',
      },
    ],
  },
];
...
export const AGREEMENT_CHECKBOXES = [
  ...
  { id: 'age25', label: 'I am the renter and am at least 25 years old' },
  { id: 'infoTrue', label: 'I confirm the information I provided at booking is true and accurate' },
  {
    id: 'cardOnFile',
    label: 'I authorize FTU to charge my card-on-file for amounts owed under this Agreement',
  },
  {
    id: 'separateFromWaiver',
    label:
      'I understand this Agreement is separate from the Liability Waiver, which I have also signed',
  },
];
...
export const AGREEMENT_APPENDIX = {
  ...
  conflict:
    'In the event of conflict between this Agreement and the above policies, this Agreement governs as to the matters covered herein.',
};
